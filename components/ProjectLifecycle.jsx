  ...
  const steps = [
    {
      ...
      // Vector visual placeholder at card bottom
      visual: (
        <svg className="w-24 h-16 text-blue-500/20" fill="none" viewBox="0 0 100 60">
          <rect x="10" y="5" width="80" height="50" rx="4" stroke="currentColor" strokeWidth="2" />
          <line x1="25" y1="20" x2="75" y2="20" stroke="currentColor" strokeWidth="2" />
          <line x1="25" y1="32" x2="65" y2="32" stroke="currentColor" strokeWidth="2" />
          <line x1="25" y1="44" x2="45" y2="44" stroke="currentColor" strokeWidth="2" />
          <circle cx="75" cy="40" r="10" stroke="currentColor" strokeWidth="2" />
          <line x1="82" y1="47" x2="88" y2="53" stroke="currentColor" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-emerald-500/20" fill="none" viewBox="0 0 100 60">
          <path d="M10 50h80V40H10v10z" stroke="currentColor" strokeWidth="2" />
          <rect x="25" y="25" width="50" height="15" rx="2" stroke="currentColor" strokeWidth="2" />
          <circle cx="50" cy="18" r="7" stroke="currentColor" strokeWidth="2" />
          <line x1="50" y1="11" x2="50" y2="4" stroke="currentColor" strokeWidth="2" />
          <line x1="45" y1="4" x2="55" y2="4" stroke="currentColor" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-purple-500/20" fill="none" viewBox="0 0 100 60">
          <rect x="15" y="10" width="30" height="40" rx="3" stroke="currentColor" strokeWidth="2" />
          <rect x="55" y="10" width="30" height="40" rx="3" stroke="currentColor" strokeWidth="2" />
          <circle cx="30" cy="30" r="6" stroke="currentColor" strokeWidth="1.5" />
          <circle cx="70" cy="30" r="6" stroke="currentColor" strokeWidth="1.5" />
          <path d="M35 15h10M35 22h10M75 15h10" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      )
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-red-500/20" fill="none" viewBox="0 0 100 60">
          <rect x="10" y="8" width="80" height="40" rx="3" stroke="currentColor" strokeWidth="2" />
          <path d="M10 40h80M30 48h40M50 40v8" stroke="currentColor" strokeWidth="2" />
          <path d="m35 20-5 4 5 4M45 20l-5 8M55 20l5-8M65 20l5 4-5 4" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      )
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-amber-500/20" fill="none" viewBox="0 0 100 60">
          <rect x="20" y="5" width="60" height="50" rx="3" stroke="currentColor" strokeWidth="2" />
          <path d="m35 25 8 8 18-18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    ...
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-indigo-500/20" fill="none" viewBox="0 0 100 60">
          <path d="M50 5v40M35 20l15-15 15 15M20 48h60" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M30 40v4M70 40v4" stroke="currentColor" strokeWidth="2" />
        </svg>
      )
    },
    {
      ...
      visual: (
        <svg className="w-24 h-16 text-cyan-500/20" fill="none" viewBox="0 0 100 60">
          <path d="M15 50 L40 30 L60 38 L85 15" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
