  ...
  const products = [
    {
      ...
      desc: "Lightning-fast digital newsrooms powered by Next.js & Headless CMS architecture.",
    ...
    },
    {
      ...
      desc: "Create, redesign, and rebuild corporate websites to elevate brand presence.",
      ...
      features: [
        "Full-Stack Next.js / React Core",
        "Traditional or Headless CMS",
        "GSAP Visual Micro-Animations",
        "SEO & Mobile Optimization",
      ],
    },
    {
      title: "General E-Commerce",
      desc: "Single-vendor e-commerce platform built on Node.js, Next.js, and MongoDB.",
      ...
      features: [
        "Unlimited Conversion Landers",
        "Abandoned Cart Recovery",
        "Pathao & Steadfast Courier APIs",
        "Fraud Guard & Bulk SMS Engine",
      ],
    },
    {
      title: "1688 API Sourcing Portal",
      desc: "Automate wholesale sourcing directly from China via 1688.com with real-time sync.",
      ...
      features: [
        "1688 Real-Time Price & Stock Sync",
        "China & BD Warehouse Barcode Scan",
        "In-Warehouse QC & Logistics",
        "Reseller Panel & OTP Verification",
      ],
    },
    {
      title: "Shipping Management System",
      desc: "Comprehensive freight & shipping management service for international importing.",
      ...
      features: [
        "Full Sourcing & Booking Workflows",
        "China & BD Warehouse Logistics",
        "Streamlined Self-Service Portal",
        "Dynamic Weight & Tariff Calculator",
      ],
    },
    {
      title: "Custom Branded E-Commerce",
      desc: "Fully custom e-commerce web applications tailored for established businesses.",
      ...
      features: [
        "Bespoke Full-Stack Stack",
        "Tailwind CSS & GSAP Animations",
        "Enterprise-Level Scalability",
        "3rd-Party Logistics & Payment APIs",
      ],
    },
    {
      title: "Restaurant Chain Management",
      desc: "All-in-one web app operating system for front & back office food management.",
      ...
      features: [
        ...
        "End-to-End Kitchen Inventory & QC",
        "Integrated Finance & HRM Suite",
      ],
    },
  ];
